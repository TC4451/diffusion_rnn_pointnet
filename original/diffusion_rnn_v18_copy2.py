...
if __name__ == "__main__":
    ...
    path_g_net = "/mnt/VOL1/fangzhou/local/trainningcode/Zilin_PointNet-WPI3/Mar8_point_net_v4_AvgPool.pth"
    ...
    g_net.eval()
    PATH_f = f"Mar8_f_rnn_v18_AvgPool_lr{params['lr_f']}_e{params['num_epochs']}.pth"
    # save model
