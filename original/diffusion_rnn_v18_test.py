...
if __name__ == "__main__":
    ...
    g_net.eval()
    PATH_f = f"Mar8_f_rnn_v18_Summation_lr{params['lr_f']}_e{params['num_epochs']}.pth"
    ...
    PATH_d = '/mnt/VOL1/fangzhou/local/trainningcode/Zilin_PointNet-WPI3/Mar9_decoder_lr0.001_e1000.pth'
