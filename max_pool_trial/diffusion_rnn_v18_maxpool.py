...
class DRNet(nn.Module):
    ...
    def forward(self, T, g_cumsum, g_pixel_tensor, loss_fn, L):
        ...
        # Initialize y_0 
        latent_y_0, _ = nn.MaxPool1d(784, return_indices=True)(g_pixel_tensor)
        latent_y_0 = latent_y_0.view(latent_y_0.size(0), -1)
        ...
        for t in timestep:
            ...
            # print(latent_y_0.size())
            # print(g_cumsum[:, :, t_prime-1].size())
...
if __name__ == "__main__":
    ...
    fn_f = f"Mar11_f_rnn_v18_maxpool_lr{params['lr_f']}_e{params['num_epochs']}"
    path_g_net = "/mnt/VOL1/fangzhou/local/trainningcode/Zilin_PointNet-WPI3/max_pool_trial/Mar11_point_net_Maxpool.pth"
