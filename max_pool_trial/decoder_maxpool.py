...
if __name__ == "__main__":
    ...
    fn_d = f"Mar11_decoder_maxpool_lr{params['lr_d']}_e{params['num_epochs_d']}"
    ...
    path_point_net = "/mnt/VOL1/fangzhou/local/trainningcode/Zilin_PointNet-WPI3/max_pool_trial/Mar11_point_net_Maxpool.pth"
    ...
    point_net.eval()
    PATH_f = "/mnt/VOL1/fangzhou/local/trainningcode/Zilin_PointNet-WPI3/max_pool_trial/Mar11_f_rnn_v18_maxpool_lr0.001_e10.pth"
    PATH_d = fn_d + ".pth"
