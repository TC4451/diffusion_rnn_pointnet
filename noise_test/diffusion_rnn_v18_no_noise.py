...
class DRNet(nn.Module):
    ...
    def forward(self, T, g_cumsum, g_pixel_tensor, loss_fn, L):
        ...
        for t in timestep:
            ...
            y_t = latent_y_0 - a_t/a_T * g_cumsum[:, :, t_prime-1]
...
if __name__ == "__main__":
    ...
    fn_f = f"Mar11_f_rnn_v18_lr{params['lr_f']}_e{params['num_epochs']}"
    path_g_net = "/mnt/VOL1/fangzhou/local/trainningcode/Zilin_PointNet-WPI3/noise_test/Mar7_point_net_v2_Summation.pth"
