...
if __name__ == "__main__":
    ...
    fn_d = f"Mar12_decoder_no_noise_lr{params['lr_d']}_e{params['num_epochs_d']}"
    ...
    path_point_net = "/mnt/VOL1/fangzhou/local/trainningcode/Zilin_PointNet-WPI3/noise_test/Mar7_point_net_v2_Summation.pth"
