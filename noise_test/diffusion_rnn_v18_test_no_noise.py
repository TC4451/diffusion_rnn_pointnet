...
if __name__ == "__main__":
    ...
    g_net.eval()
    PATH_f = f"/mnt/VOL1/fangzhou/local/trainningcode/Zilin_PointNet-WPI3/noise_test/Mar11_f_rnn_v18_lr0.001_e10.pth"
    ...
    PATH_d = '/mnt/VOL1/fangzhou/local/trainningcode/Zilin_PointNet-WPI3/noise_test/Mar12_decoder_no_noise_lr0.001_e1000.pth'
