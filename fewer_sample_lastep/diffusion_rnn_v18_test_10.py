...
half_train_size = len(mnist_train_full) // 10
...
def test_f(point_net, trained_f_net, trained_decoder, params):
    ...
    plt.grid(True)
    plt.savefig('Mar17_tsne_y0_10.png')
    plt.close()
    ...
    plt.ylabel('Component 2')
    plt.grid(True)
    plt.savefig('Mar17_tsne_g_pixel_10.png')
...
if __name__ == "__main__":
    ...
    path_g_net = "Mar15_point_net_v3_10_train.pth"
    ...
    g_net.eval()
    PATH_f = f"Mar17_f_rnn_v18_10.pth"
