...
def test_f(point_net, trained_f_net, trained_decoder, params):
    ...
    plt.grid(True)
    plt.savefig('Mar15_tsne_y0_noise_scale_e300.png')
    plt.close()
    ...
    plt.ylabel('Component 2')
    plt.grid(True)
    plt.savefig('Mar15_tsne_g_pixel_noise_scale_e300.png')
...
if __name__ == "__main__":
    ...
    g_net.eval()
    PATH_f = f"Mar14_f_rnn_v18_noise_scale_lr0.001_e10.pth"
    ...
    PATH_d = 'Mar15_decoder_noise_scale_lr0.001_e300.pth'
