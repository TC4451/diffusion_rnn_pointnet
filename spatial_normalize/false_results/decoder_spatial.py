...
if __name__ == "__main__":
    ...
    fn_d = f"Mar13_decoder_spatial_nobn_lr{params['lr_d']}_e{params['num_epochs_d']}"
    ...
    path_point_net = "/mnt/VOL1/fangzhou/local/trainningcode/Zilin_PointNet-WPI3/spatial_expand/Mar11_point_net_v5_spatial.pth"
