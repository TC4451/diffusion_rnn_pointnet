...
# Define the transformations as binary encoding
...
fn = "Mar20_point_net_norm_spatial_encoding"

# get coordinates of pixels
coords_x, coords_y = torch.meshgrid(torch.arange(0, 28)/28, torch.arange(0, 28)/28)
print(coords_x)
print(coords_y)
